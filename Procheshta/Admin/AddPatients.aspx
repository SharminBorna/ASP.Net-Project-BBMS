<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddPatients.aspx.cs" Inherits="Procheshta.Admin.AddPatients" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <asp:DropDownList ID="ddlGender" CssClass="form-control form-control-sm col-md-4" runat="server" DataValueField="gender" AppendDataBoundItems="true">
                                <asp:ListItem Value="" Selected="True">---Select One---</asp:ListItem>
                                <asp:ListItem>Male</asp:ListItem>
                                <asp:ListItem>Female</asp:ListItem>
                                <asp:ListItem>Others</asp:ListItem>
                            </asp:DropDownList>
                            &nbsp;&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Gender is Required" ForeColor="Red" ControlToValidate="ddlGender" Display="Dynamic" ValidationGroup="Insert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <asp:DropDownList ID="ddlBloodGroup" CssClass="form-control form-control-sm col-md-4" runat="server" DataValueField="bloodGroup" AppendDataBoundItems="true">
                                <asp:ListItem Value="" Selected="True">---Select One---</asp:ListItem>
                            ...
                            &nbsp;&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Blood Group is Required" ForeColor="Red" ControlToValidate="ddlBloodGroup" Display="Dynamic" ValidationGroup="Insert">
                            </asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    <div class="offset-2">
        <a class="btn btn-info" runat="server" href="~/Admin/PatientsDetails.aspx"><i class="fa fa-arrow-alt-circle-left"></i> Back to List</a>
