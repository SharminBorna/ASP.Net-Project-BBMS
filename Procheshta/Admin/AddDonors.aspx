<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddDonors.aspx.cs" Inherits="Procheshta.Admin.AddDonors" %>
        ...
        <div class="col">
            ...
            <div class="col-md-6 float-left">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <asp:DropDownList ID="ddlGender" CssClass="form-control form-control-sm col-md-9" runat="server" DataValueField="gender" AppendDataBoundItems="true">
            ...
            <div class="col-md-6 float-right">
                ...
                <div class="offset-3">
                    &nbsp;&nbsp;<a class="btn btn-info" runat="server" href="~/Admin/DonorDetails.aspx"><i class="fa fa-arrow-alt-circle-left"></i>Back to List</a>
